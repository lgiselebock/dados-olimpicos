...
# conta o número de atletas, equipes (países) e modalidades participantes das Olímpidas.
...
contagem_NOC |>
  ...
  ggplot2::labs(
    ...
    # subtitle = "das delegações participantes",
    caption = "Elaboração própria (2021)",
    x = "Homens",
    y = "Mulheres"
  ) +
...
mundo |> 
  ...
  ggplot2::scale_fill_gradient(low = "lightblue", high = "red", na.value = "gray") +
  ggplot2::theme_void() +
  ggplot2::theme(legend.position = "bottom",
